...
/**
 * No runtime invariant: the package is a static patch-list carrier (the same
 * posture as dsh-base and dsh-headless) — it owns no plugin body, no event
 * stream, and no mutable data to audit inside the tree.
 */
